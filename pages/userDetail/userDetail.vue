<template>
	<view>
		...
		<view class="content   px-3 p-r line-h">
			...
			<view class="p-r">
				...
				<view class="color6 flex flex-wrap pb-2">
					<view class="pt-4 w-50">年龄：<text class="color2">{{mainData.zo_age?mainData.zo_age:'-'}}</text></view>
					<view class="pt-4 w-50">身高：<text class="color2">{{mainData.zo_height?mainData.zo_height:'-'}}</text></view>
					<view class="pt-4 w-50">学历：<text class="color2">{{mainData.zo_education?mainData.zo_education:'-'}}</text></view>
		...
		<view class="bg-white p-fX flex1 bottom-0  bT-e1 py-2 px-3" style="background-color: rgba(255,255,255,1);">
...
.homeBg{width: 100%;height: 310rpx;}
.head .tit{line-height: 100rpx;}
.content{margin-top: 145rpx;background-color: rgba(255,255,255,0.7);}
